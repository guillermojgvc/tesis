...
Ext.ux.grid.GridFilters = Ext.extend(Ext.util.Observable, {
    ...
    init : function (grid) {
        ...
        if (grid.tableGrid instanceof Ext.grid.GridPanel) {
        ...
        } else if (grid.tableGrid instanceof Ext.PagingToolbar) {
            this.toolbar = grid.tableGrid;
        }
    },
