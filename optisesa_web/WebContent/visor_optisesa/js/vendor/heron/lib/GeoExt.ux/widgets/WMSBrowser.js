...
GeoExt.ux.WMSBrowser = Ext.extend(Ext.Panel, {
    ...
    inputURLText: "Seleccione o ingrese una dirección de servidor WMS (URL)",

    /** api: config[connectText] ``String`` i18n */
    connectText: "Conectado",

    /** api: config[pleaseInputURLText] ``String`` i18n */
    pleaseInputURLText: "Por favor, primero seleccione o ingrese una dirección de servidor WMS" ,
    ...
    addSelectedLayersText: "Agregar capas seleccionadas como una sola capa.",

    /** api: config[mapPanelPreviewTitleText] ``String`` i18n */
    mapPanelPreviewTitleText: "Vista previsa de la capa ",

    /** api: config[layerCantBeAddedText] ``String`` i18n */
    layerCantBeAddedText: "Esta capa no puede ser agregada : ",

    /** api: config[srsNotSupportedText] ``String`` i18n */
    srsNotSupportedText: "Esta capa no puede ser agregada al mapa actual" + 
                         " debido a que no soporta la proyeccción.",

    /** api: config[srsNotSupportedShortText] ``String`` i18n */
    srsNotSupportedShortText: "no soporta la proyeccción actual del mapa",

    /** api: config[extentNotSupportedShortText] ``String`` i18n */
    extentNotSupportedShortText: "esta fueraa de la extensión del mapa",

    /** api: config[pleaseSelectALayerText] ``String`` i18n */
    pleaseSelectALayerText: "Por favor, primero seleccione una o mas capas del listado.",

    /** api: config[pleaseSelectALayerText] ``String`` i18n */
    pleaseCheckALayerInTreeText: "Por favor, primero eliga una o mas capas del listado.",

    /** api: config[closeWindowText] ``String`` i18n */
    closeWindowText: "Cerrar ventana",

    /** api: config[closeText] ``String`` i18n */
    closeText: "Cerrar",

    /** api: config[inputURLInvalidText] ``String`` i18n */
    inputURLInvalidText: "La dirección ingresada no es valida.",

    /** api: config[layerNameText] ``String`` i18n */
    layerNameText: "Nombre de la capa :",

    /** api: config[noLayerReturnedText] ``String`` i18n */
    noLayerReturnedText: "La dirección ingresada es valida pero no retorna niguna capa.",

    /** api: config[layersSuccessfullyLoadedText] ``String`` i18n */
    layersSuccessfullyLoadedText: "Capas cargadas exitosamente.",

    /** api: config[layerAddedText] ``String`` i18n */
    layerAddedText: "Capa(s) agregadas al mapa exitosamente.",

    /** api: config[urlInvalidText] ``String`` i18n */
    urlInvalidText: "La dirección del servidor es invalida o no es un servidor WMS valido.",

    /** api: config[pleaseInputLayerNameText] ``String`` i18n */
    pleaseInputLayerNameText: "Por favor, un nombre de capa en la caja de texto inferior.",
