...
Heron.i18n.dict = {
	...
	'Length': 'Longitud',
	'Area': 'Area',
	'Result >': 'Ir al panel de resultados >>',
	'< Search': '<< Ir a panel de búsquedas',
	'Search': 'Busqueda',
    ...
    'Search by Drawing': 'Búsqueda geográfica',
    'LabelLayer': '1. Seleccione la capa geográfica en la que desea realizar la búsqueda',
    'LabelTool': '2. Seleccione el elemento grafico con el que desea realizar la búsqueda',
    'LabelSearch': '3. Sobre el mapa marque el área geográfica de búsqueda',
    ...
    'Return to map navigation': 'Moverse por el mapa',
    'Draw point': 'Delimitar el área de interés con un punto',
    'Draw line': 'Delimitar el área de interés con una línea',
    'Draw polygon': 'Delimitar el área de interés con un poligono',
    'Draw circle (click and drag)': 'Delimitar el área de interés con un círculo (click y arrastre)',
    'Draw Rectangle (click and drag)': 'Delimitar el área de interés con un rectangulo (click y arrastre)',
    ...
    'Input system': 'Sistema de coordenadas',
    'Choose input system...': 'Elegir sistema de coordenadas...',
    ...
    'Remove markers on close': 'Quitar marcas de posición al cerrar',
    'Remove markers': 'Quitar marcas de posición',
    'Location': 'Posicion',
    ...
    'Select a drawing tool and draw to search immediately': 'Siga las instrucciones para buscar.',
    'Search in': '',
    'Search Canceled': 'Búsqueda cancelada',
    'Help and info for this example': 'Ayuda para este ejemplo'
};
var map_Point_GetCoordinates_tooltip = "Punto de Coordenadas";
var map_Point_SetCoordinates_tooltip = "Colocar Coordenadas";
var map_Point_GetCoordinates_title = "Obtener Coordenadas";
var map_Point_GetCoordinates_WGS = "WGS 84";
var map_Point_GetCoordinates_EGSA = "Google Mercator";
var map_Point_SetCoordinates_title = "Colocar Coordenadas";
var map_Point_SetCoordinates_Clear = "Limpiar";
var map_Point_SetCoordinates_Show = "Mostrar";
var map_Point_SetCoordinates_Show_Markers = "Mostrar";
var map_Point_SetCoordinates_lon = "Longitud";
var map_Point_SetCoordinates_lat = "Latitud";
var map_Point_SetCoordinates_Projection = "Proyección";
var map_Point_SetCoordinates_Combo_WGS = "WGS 84";
var map_Point_SetCoordinates_Combo_EGSA = "EGSA 87";
var map_Point_SetCoordinates_Combo_EmptyText = "Elegir Proyección";